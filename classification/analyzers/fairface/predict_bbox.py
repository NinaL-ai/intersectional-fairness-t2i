...
def detect_face(image_paths, SAVE_DETECTED_AT, default_max_size=800, size = 300, padding = 0.25):
    cnn_face_detector = dlib.cnn_face_detection_model_v1('classification/analyzers/fairface/dlib_models/mmod_human_face_detector.dat')
    sp = dlib.shape_predictor('classification/analyzers/fairface/dlib_models/shape_predictor_5_face_landmarks.dat')
...
def predidct_age_gender_race(save_prediction_at, bboxes, imgs_path = 'cropped_faces/'):
    ...
    model_fair_7.load_state_dict(torch.load('classification/analyzers/fairface/fair_face_models/res34_fair_align_multi_7_20190809.pt'))
    ...
    model_fair_4.load_state_dict(torch.load('classification/analyzers/fairface/fair_face_models/fairface_alldata_4race_20191111.pt'))
    ...
    print("saved fairface results at ", save_prediction_at)
